...
//     const PostImg = async function(newImg) {
//         console.log(newImg);
...
//         })
//     }
//     PostImg(newImg.value);

// });

// const myForm = document.getElementById('creation');

// NB event listener on form and not button
enregistrerArticle.addEventListener('click', function(e) {
    e.preventDefault();
